...
function logaccess( $p_db, $p_user, $p_source, $p_detail ) {
  ...
  $insert = mysqli_query($p_db, $q_string) or die(header("Location: " . $Siteroot . "/error.php?script=" . $package . "&called=" . $called . "&error=" . $q_string . "&mysql=" . mysqli_error($p_db)));
}
...
function check_userlevel( $p_db, $p_level ) {
  ...
  if (isset($_SESSION['username'])) {
    ...
    $q_user_level = mysqli_query($p_db, $q_string) or die(header("Location: " . $Siteroot . "/error.php?script=" . $package . "&called=" . $called . "&error=" . $q_string . "&mysql=" . mysqli_error($p_db)));
...
function new_Mysql($p_db) {
  ...
  $q_version = mysqli_query($p_db, $q_string) or die(header("Location: " . $Siteroot . "/error.php?script=" . $package . "&called=" . $called . "&error=" . $q_string . "&mysql=" . mysqli_error($p_db)));
...
function last_insert_id($p_db) {
  ...
  $q_result = mysqli_query($p_db, $q_string) or die(header("Location: " . $Siteroot . "/error.php?script=" . $package . "&called=" . $called . "&error=" . $q_string . "&mysql=" . mysqli_error($p_db)));
...
#  $result = mysqli_query($p_db, $q_string) or die(header("Location: " . $Siteroot . "/error.php?script=" . $package . "&called=" . $called . "&error=" . $q_string . "&mysql=" . mysqli_error($p_db)));
...
# if primary group, just return
    ...
    $q_string .= "from users ";
    $q_string .= "where usr_id = " . $_SESSION['uid'];
    $q_users = mysqli_query($p_db, $q_string) or die(header("Location: " . $Siteroot . "/error.php?script=" . $package . "&called=" . $called . "&error=" . $q_string . "&mysql=" . mysqli_error($p_db)));
...
# check extended groups next...
    ...
    $q_grouplist = mysqli_query($p_db, $q_string) or die(header("Location: " . $Siteroot . "/error.php?script=" . $package . "&called=" . $called . "&error=" . $q_string . "&mysql=" . mysqli_error($p_db)));
...
function return_Index( $p_db, $p_check, $p_string ) {
  ...
  $r_index = 0;
  $count = 0;
  $q_table = mysqli_query($p_db, $q_string) or die(header("Location: " . $Siteroot . "/error.php?script=" . $package . "&called=" . $called . "&error=" . $q_string . "&mysql=" . mysqli_error($p_db)));
...
# first check production systems.
  ...
  $q_inventory = mysqli_query($p_db, $q_string) or die(header("Location: " . $Siteroot . "/error.php?script=" . $package . "&called=" . $called . "&error=" . $q_string . "&mysql=" . mysqli_error($p_db)));
...
function return_Virtual( $p_db, $p_string ) {
  ...
  $q_hardware = mysqli_query($p_db, $q_string) or die(header("Location: " . $Siteroot . "/error.php?script=" . $package . "&called=" . $called . "&error=" . $q_string . "&mysql=" . mysqli_error($p_db)));
...
function return_System( $p_db, $p_string ) {
  ...
  $q_software = mysqli_query($p_db, $q_string) or die(header("Location: " . $Siteroot . "/error.php?script=" . $package . "&called=" . $called . "&error=" . $q_string . "&mysql=" . mysqli_error($p_db)));
...
function show_Help( $p_db, $p_script ) {
  ...
  $q_help = mysqli_query($p_db, $q_string) or die(header("Location: " . $Siteroot . "/error.php?script=" . $package . "&called=" . $called . "&error=" . $q_string . "&mysql=" . mysqli_error($p_db)));
