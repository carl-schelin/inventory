...
<?php
  ...
  print "  <th class=\"ui-state-default\">CPU</th>\n";
  print "  <th class=\"ui-state-default\">Size</th>\n";
  ...
  $q_string  = "select inv_id,inv_name,inv_ssh,mod_name,mod_size,mod_speed,hw_update,hw_verified,usr_last ";
