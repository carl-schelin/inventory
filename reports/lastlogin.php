...
<?php
  ...
  $q_users = mysql_query($q_string) or die (mysql_error());
  while ($a_users = mysql_fetch_array($q_users)) {
    ...
    $q_log = mysql_query($q_string) or die($q_string . ": " . mysql_error());
    $logs = mysql_num_rows($q_log);
