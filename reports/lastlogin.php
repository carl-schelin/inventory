...
tabs displaying all the hardware associated with the product and the software.</p>
...
<?php
  ...
  while ($a_inv_users = mysqli_fetch_array($q_inv_users)) {
    ...
    if ($logs > 0) {
    print "<tr>\n";
    print "  <td class=\"" . $class . "\">" . $a_inv_users['usr_last'] . ", " . $a_inv_users['usr_first'] . "</a></td>\n";
    print "  <td class=\"" . $class . "\">" . $a_inv_users['usr_checkin'] . "</td>\n";
    print "  <td class=\"" . $class . "\">" . $a_inv_users['usr_ipaddr'] . "</td>\n";
