...
<ul>
  ...
  <li><strong>Product Listing</strong> - A breakdown of every Product supported by the selected team and the number of servers associated with that product. The linked page will display all systems associated with the Product which may be the same or more overall systems as other teams have systems in that same Product.</li>
