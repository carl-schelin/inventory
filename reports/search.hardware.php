...
function clear_fields() {
  show_file('search.php?search_by=4&search_for=<?php print $formVars['search_for']; ?>');
}
...
<ul>
  ...
  <ul>
    <li><strong>Server Name</strong> - Clicking on the Server Name will bring up the Detailed Server View with a focus on the Hardware tab.</li>
    <li><strong>Vendor</strong> - Clicking on a Vendor will restart the search using the selected Vendor as the search criteria.</li>
    <li><strong>Model</strong> - Clicking on a Model will restart the search using the selected Model as the search criteria.</li>
    <li><strong>Type</strong> - Clicking on a Model Type will restart the search using the selected Type as the search criteria.</li>
    <li><strong>Managed By</strong> - Clicking on the Group managing this device will bring up the Detailed Server View starting from the Detail page (different than the server selection which starts you off on the Hardware tab).</li>
  </ul></li>
</ul>
...
<span id="hardware_search_mysql"><?php print wait_Process('Waiting...')?></span>
