...
# if a console or LOM interface type
      ...
      if (check_userlevel($AL_Edit)) {
        $editpencil = "<img class=\"ui-icon-edit\" src=\"/inventory/imgs/pencil.gif\" height=\"10\"></a>";
...
# print the actual data row
      if ($formVars['csv'] == 'false') {
        ...
        print "  <td " . $class . "><nobr>" . $a_inventory['loc_name']  . $showend . "</nobr></td>\n";
        print "  <td " . $class . "><nobr>" . $a_inventory['loc_addr1'] . $showend . "</nobr></td>\n";
        print "  <td " . $class . "><nobr>" . $a_inventory['loc_addr2'] . $showend . "</nobr></td>\n";
        print "  <td " . $class . "><nobr>" . $a_inventory['loc_suite'] . $showend . "</nobr></td>\n";
        print "  <td " . $class . ">" . $a_inventory['ct_city']         . $showend . "</td>\n";
