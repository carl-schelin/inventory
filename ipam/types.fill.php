...
# Description:
  ...
  if (isset($_SESSION['username'])) {
    ...
    if (check_userlevel($db, $AL_Edit)) {
      logaccess($db, $_SESSION['uid'], $package, "Requesting record " . $formVars['id'] . " from inv_ip_types");
      ...
      print "document.formUpdate.ip_name.value = '"        . mysqli_real_escape_string($db, $a_inv_ip_types['ip_name'])        . "';\n";
      print "document.formUpdate.ip_description.value = '" . mysqli_real_escape_string($db, $a_inv_ip_types['ip_description']) . "';\n";
