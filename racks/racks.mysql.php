...
# Description: Retrieve data and update the database with the new info. Prepare and display the table
  ...
  if (isset($_SESSION['username'])) {
    ...
    if (check_userlevel($db, $AL_Edit)) {
      ...
      $output .= "  <th class=\"ui-state-default\"><a href=\"racks.php?sort=ast_name"   . "\">" . "Name or Label" . "</a></th>\n";
      $output .= "  <th class=\"ui-state-default\"><a href=\"racks.php?sort=mod_name"   . "\">" . "Device"        . "</a></th>\n";
      $output .= "  <th class=\"ui-state-default\"><a href=\"racks.php?sort=ast_unit"   . "\">" . "Starting Unit" . "</a></th>\n";
      $output .= "  <th class=\"ui-state-default\"><a href=\"racks.php?sort=ast_facing" . "\">" . "Facing"        . "</a></th>\n";
      $output .= "  <th class=\"ui-state-default\"><a href=\"racks.php?sort=ast_asset"  . "\">" . "Asset Tag"     . "</a></th>\n";
      $output .= "  <th class=\"ui-state-default\"><a href=\"racks.php?sort=ast_serial" . "\">" . "Serial Number" . "</a></th>\n";
      ...
      $q_string .= "where ast_parentid = 0 and part_name = \"Rack\" ";
      $q_string .= $orderby;
...
# if it has an asset tag but isn't managed in the asset tracking system, make some noise
          if ($a_inv_assets['ast_asset'] != '') {
            if ($a_inv_assets['ast_managed'] == 0) {
              $class = "ui-state-error";
            }
          }

          $linkstart = "<a href=\"#\" onclick=\"show_file('racks.fill.php?id="  . $a_inv_assets['ast_id'] . "');jQuery('#dialogUpdate').dialog('open');return false;\">";
          $linkdel   = "<input type=\"button\" value=\"Remove\"  onclick=\"delete_line('racks.del.php?id=" . $a_inv_assets['ast_id'] . "');\">";
          $linkend   = "</a>";
          ...
          $totallink = '';
          if ($total > 0) {
            $totallink = "<a href=\"racks.members.php?id=" . $formVars['ast_id'] . "\" target=\"_blank\">";
          }
...
####
          ...
          $q_string .= "order by ast_facing desc,ast_unit desc,ast_name ";
          ...
          if (mysqli_num_rows($q_child) > 0) {
            while ($a_child = mysqli_fetch_array($q_child)) {
              ...
              $linkstart = "<a href=\"#\" onclick=\"show_file('racks.fill.php?id="  . $a_child['ast_id'] . "');jQuery('#dialogUpdate').dialog('open');return false;\">";
              $linkdel   = "<input type=\"button\" value=\"Remove\"  onclick=\"delete_line('racks.del.php?id=" . $a_child['ast_id'] . "');\">";
              $linkend   = "</a>";
