...
function delete_line( p_script_url ) {
  var answer = confirm("Delete this Rack?")
...
function clear_fields() {
  show_file('racks.mysql.php?update=-1&sort=<?php print $formVars['sort']; ?>');
}
    ...
    buttons: [
      {
        text: "Cancel",
        click: function() {
          show_file('racks.mysql.php?update=-1');
          $( this ).dialog( "close" );
        }
      },
      {
