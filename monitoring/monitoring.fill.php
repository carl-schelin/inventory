...
#+-----------------+---------+------+-----+---------+----------------+
      ...
      $a_inv_monitoring = mysqli_fetch_array($q_inv_monitoring);
      mysqli_free_result($q_inv_monitoring);

      print "document.monitoring.mon_openview.value = '" . mysqli_real_escape_string($db, $a_inv_monitoring['mon_openview']) . "';\n";
      print "document.monitoring.mon_openview.value = '" . mysqli_real_escape_string($db, $a_inv_monitoring['mon_openview']) . "';\n";
      print "document.monitoring.mon_openview.value = '" . mysqli_real_escape_string($db, $a_inv_monitoring['mon_openview']) . "';\n";
      print "document.monitoring.mon_openview.value = '" . mysqli_real_escape_string($db, $a_inv_monitoring['mon_openview']) . "';\n";
      print "document.monitoring.mon_openview.value = '" . mysqli_real_escape_string($db, $a_inv_monitoring['mon_openview']) . "';\n";
