...
# Description: 
  ...
  if (isset($_SESSION['username'])) {
    ...
    if (check_userlevel($db, $AL_Edit)) {
      logaccess($db, $_SESSION['uid'], $package, "Requesting record " . $formVars['id'] . " from inv_excludes");
      ...
      print "document.exclude.ex_expiration.value = '" . mysqli_real_escape_string($db, $a_inv_excludes['ex_expiration']) . "';\n";
