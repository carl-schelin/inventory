...
<p>There are two files that are created. A prefilter file which is also called messages.exclude which is located on each server in the /opt/unixsuite/etc directory. The script only pulls in lines that 
