...
--
-- Table structure for table `inv_bugs`
--

DROP TABLE IF EXISTS `inv_bugs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `inv_bugs` (
  ...
  `bug_discovered` date NOT NULL DEFAULT '1971-01-01',
  `bug_closed` date NOT NULL DEFAULT '1971-01-01',
