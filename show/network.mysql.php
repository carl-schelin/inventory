...
# if help has not been seen yet,
  ...
  $q_string .= "left join inv_net_zones  on interface.int_zone = inv_net_zones.zone_id  ";
  $q_string .= "left join inv_int_types  on interface.int_type = inv_int_types.itp_id ";
...
# IP6 table
  ...
  $q_string = "select int_id,int_server,int_domain,int_face,int_addr,int_eth,int_mask,int_verified,int_sysport,int_redundancy,int_virtual,"
            ...
            . "from interface "
            . "left join inv_net_zones on interface.int_zone = inv_net_zones.zone_id  "
