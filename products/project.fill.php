...
# Description: 
  ...
  if (isset($_SESSION['username'])) {
    ...
    if (check_userlevel($db, $AL_Edit)) {
      ...
      $q_string  = "select prod_name,prod_code,prod_desc,prod_directory,prod_unit,prod_service ";
      ...
      print "document.formUpdate.prod_directory.value = '" . mysqli_real_escape_string($db, $a_inv_products['prod_directory']) . "';\n";
