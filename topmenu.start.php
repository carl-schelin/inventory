...
<ul id="topmenu">
  ...
  <li id="tm_siteadmin"><a href="<?php print $Siteroot; ?>/index.organization.php">Organization</a>
    <ul>
...
?>
  ...
  <li id="tm_database"><a href="<?php print $Siteroot; ?>/index.manage.php">Inventory Administration</a></li>
