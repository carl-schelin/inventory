...
#
  ...
  if (isset($_SESSION['username'])) {
    ...
    if (check_userlevel($AL_Edit)) {
      ...
      $q_issue_morning = mysql_query($q_string) or die (mysql_error());
      $a_issue_morning = mysql_fetch_array($q_issue_morning);
      ...
      print "document.start.morn_text.value = '"      . mysql_real_escape_string($a_issue_morning['morn_text'])      . "';\n";
      print "document.start.morn_timestamp.value = '" . mysql_real_escape_string($a_issue_morning['morn_timestamp']) . "';\n";
