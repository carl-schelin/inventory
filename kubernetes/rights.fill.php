...
# Description:
  ...
  if (isset($_SESSION['username'])) {
    ...
    if (check_userlevel($db, $AL_Edit)) {
      logaccess($db, $_SESSION['uid'], $package, "Requesting record " . $formVars['id'] . " from rights");
      ...
      $apigroups = return_Index($db, $a_rights['rgt_apigroup'], "select api_id from apigroups order by api_name");
      $resources = return_Index($db, $a_rights['rgt_resource'], "select res_id from resources order by res_name");
