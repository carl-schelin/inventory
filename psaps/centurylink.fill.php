...
# Description: 
  ...
  if (isset($_SESSION['username'])) {
    ...
    if (check_userlevel($db, $AL_Edit)) {
      ...
      print "document.psaps.psap_customerid.value = '"    . mysqli_real_escape_string($db, $a_psaps['psap_customerid'])    . "';\n";
      print "document.psaps.psap_parentid.value = '"      . mysqli_real_escape_string($db, $a_psaps['psap_parentid'])      . "';\n";
      print "document.psaps.psap_ali_id.value = '"        . mysqli_real_escape_string($db, $a_psaps['psap_ali_id'])        . "';\n";
      print "document.psaps.psap_companyid.value = '"     . mysqli_real_escape_string($db, $a_psaps['psap_companyid'])     . "';\n";
      ...
      print "document.psaps.psap_pseudo_cid.value = '"    . mysqli_real_escape_string($db, $a_psaps['psap_pseudo_cid'])    . "';\n";
      print "document.psaps.psap_lec.value = '"           . mysqli_real_escape_string($db, $a_psaps['psap_lec'])           . "';\n";
      print "document.psaps.psap_texas.value = '"         . mysqli_real_escape_string($db, $a_psaps['psap_texas'])         . "';\n";
      print "document.psaps.psap_updated.value = '"       . mysqli_real_escape_string($db, $a_psaps['psap_updated'])       . "';\n";
      print "document.psaps.psap_delete.value = '"        . mysqli_real_escape_string($db, $a_psaps['psap_delete'])        . "';\n";
