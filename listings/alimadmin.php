...
<title>Manage ALIM Server Listing</title>
...
function clear_fields() {
  show_file('alimadmin.mysql.php?update=-1');
}
  ...
  $( "#dialogListing" ).dialog({
    ...
    buttons: [
      ...
      },
      {
        text: "Update Listing",
        click: function() {
          attach_file('alimadmin.mysql.php', 1);
          $( this ).dialog( "close" );
        }
      },
      {
        text: "Add Listing",
        click: function() {
          attach_file('alimadmin.mysql.php', 0);
          $( this ).dialog( "close" );
        }
      }
    ]
...
<ul>
  ...
  <ul>
    <li><strong>Refresh Listing</strong> - This rebuilds the ALIM SysAdmin server listing file.</li>
  </ul></li>
</ul>
...
<input type="button"                 name="refresh" value="Refresh Listing" onClick="javascript:attach_file('alimadmin.mysql.php', 2);">
</td>
</tr>
</table>
