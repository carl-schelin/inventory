...
<title>Manage Voice Network Support Listing</title>
...
function clear_fields() {
  show_file('vns.mysql.php?update=-1');
}
...
<ul>
  ...
  <ul>
    <li><strong>Refresh Listing</strong> - This rebuilds the Voice Network Support server listing file.</li>
  </ul></li>
</ul>
...
<input type="button"                 name="refresh" value="Refresh Listing" onClick="javascript:attach_file('vns.mysql.php', 2);">
</td>
</tr>
</table>
