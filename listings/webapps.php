...
# connect to the database
  ...
  logaccess($db, $_SESSION['uid'], $package, "Viewing the web listing table");
...
<title>Manage Web Listing</title>
...
function clear_fields() {
  show_file('webapps.mysql.php?update=-1');
}
  ...
  $( "#dialogListing" ).dialog({
    ...
    buttons: [
      ...
      },
      {
        text: "Update Listing",
        click: function() {
          attach_file('webapps.mysql.php', 1);
          $( this ).dialog( "close" );
        }
      },
      {
        text: "Add Listing",
        click: function() {
          attach_file('webapps.mysql.php', 0);
          $( this ).dialog( "close" );
        }
      }
    ]
...
<p>This listing consists of the systems managed by the Web Applications Team. The listing is automatically generated. Systems are 
added here by being identified as the Applications Owner for the system. As multiple groups can claim to be the Applications Owner, 
you can also claim software hosted on a system. To do so, search for the system, click on the 'pencil' to edit it, click on the 
'Software' tab, click on the 'Software Management' title bar to open the form, and fill it out.</p>
...
<input type="button"                 name="refresh" value="Refresh Listing" onClick="javascript:attach_file('webapps.mysql.php', 2);">
</td>
</tr>
</table>
