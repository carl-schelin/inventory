...
# Description: Retrieve data and update the database with the new info. Prepare and display the table
  ...
  if (isset($_SESSION['username'])) {
    $package            = "alimadmin.mysql.php";
    $myfill             = "alimadmin.fill.php";
    $mydel              = "alimadmin.del.php";
    $mygroup            = $GRP_ALIMAdmin;
    $myserver           = "servers.ali";
...
# scripts use the "^#" part to make sure commented servers are able to use the changelog process
            ...
            $q_string .= "from tags ";
            $q_string .= "where tag_companyid = " . $a_software['invid'] . " and tag_type = 1 ";
