...
<title>Manage SCM Listing</title>
...
function clear_fields() {
  show_file('scm.mysql.php?update=-1');
}
...
<p>This listing consists of the systems managed by SCM. The listing is automatically generated. To add a server to 
...
<ul>
  ...
  <ul>
    <li><strong>Refresh Listing</strong> - This rebuilds the SCM server listing file.</li>
  </ul></li>
</ul>
...
<input type="button"                 name="refresh" value="Refresh Listing" onClick="javascript:attach_file('scm.mysql.php', 2);">
</td>
</tr>
</table>
