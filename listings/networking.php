...
<title>Manage Networking Listing</title>
...
function clear_fields() {
  show_file('networking.mysql.php?update=-1');
}
  ...
  $( "#dialogListing" ).dialog({
    ...
    buttons: [
      ...
      },
      {
        text: "Update Listing",
        click: function() {
          attach_file('networking.mysql.php', 1);
          $( this ).dialog( "close" );
        }
      },
      {
        text: "Add Listing",
        click: function() {
          attach_file('networking.mysql.php', 0);
          $( this ).dialog( "close" );
        }
      }
    ]
...
<input type="button"                 name="refresh" value="Refresh Listing" onClick="javascript:attach_file('networking.mysql.php', 2);">
</td>
</tr>
</table>
