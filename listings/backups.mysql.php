...
# Description: Retrieve data and update the database with the new info. Prepare and display the table
  ...
  if (isset($_SESSION['username'])) {
    ...
    $myfill             = "backups.fill.php";
    $mydel              = "backups.del.php";
    $mygroup            = $GRP_Backups;
    $myserver           = "servers.sba";
...
# As most systems will have backup software install, the backup group asked that only systems with group created tags are added to the servers.sba file
            if (strlen($tags) > 0) {
