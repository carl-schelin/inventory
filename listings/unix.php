...
<title>Manage Unix Listing</title>
...
function clear_fields() {
  show_file('unix.mysql.php?update=-1');
}
...
<input type="button"                 name="refresh" value="Refresh Listing" onClick="javascript:attach_file('unix.mysql.php', 2);">
</td>
</tr>
</table>
