...
# Description: Retrieve data and update the database with the new info. Prepare and display the table
  ...
  if (isset($_SESSION['username'])) {
    $package            = "unix.mysql.php";
    $myfill             = "unix.fill.php";
    $mydel              = "unix.del.php";
    $mygroup            = $GRP_Unix;
    $myserver           = "servers.unix";
...
# now write the servers file
      if ($formVars['update'] == 2) {
        ...
        if ($handle) {
          ...
          $q_string  = "select inv_id,inv_name,inv_fqdn,inv_zone,inv_ssh,prod_name ";
...
# scripts use the "^#" part to make sure commented servers are able to use the changelog process
            ...
            $q_string .= "from tags ";
            $q_string .= "where tag_companyid = " . $a_software['inv_id'] . " and tag_type = 1 ";
            ...
            $product = str_replace(" ", "_", $a_software['prod_name']);
            if ($product == '') {
              $product = "Unassigned";
            }

            $output = $pre . $a_software['inv_name'] . ":" . $a_software['inv_fqdn'] . ":$os:" . $zonename[$a_software['inv_zone']] . ":$tags:$interfaces:" . $a_software['inv_id'] . ":" . $product . "\n";
            fwrite($handle, $output);

          }

# add the applications for changelog work
...
# scripts use the "^#" part to make sure commented servers are able to use the changelog process
          ...
          $output .= "  <td class=\"ui-widget-content\">" . $product                           . "</td>\n";
          $output .= "</tr>\n";
