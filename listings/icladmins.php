...
# connect to the database
  ...
  $package = "icladmins.php";

  logaccess($db, $_SESSION['uid'], $package, "Viewing the ICL server listing table");
...
<title>Manage ICL Listing</title>
...
function clear_fields() {
  show_file('icladmins.mysql.php?update=-1');
}
  ...
  $( "#dialogListing" ).dialog({
    ...
    buttons: [
      ...
      },
      {
        text: "Update Listing",
        click: function() {
          attach_file('icladmins.mysql.php', 1);
          $( this ).dialog( "close" );
        }
      },
      {
        text: "Add Listing",
        click: function() {
          attach_file('icladmins.mysql.php', 0);
          $( this ).dialog( "close" );
        }
      }
    ]
...
<p>This listing consists of the systems managed by the Unix Team. The listing is automatically generated. To add a server to 
...
<ul>
  ...
  <ul>
    <li><strong>Refresh Listing</strong> - This rebuilds the Unix server listing file.</li>
  </ul></li>
</ul>
...
<input type="button"                 name="refresh" value="Refresh Listing" onClick="javascript:attach_file('icladmins.mysql.php', 2);">
</td>
</tr>
</table>
