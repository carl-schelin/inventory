...
<title>Manage i3 App Sys Admins Listing</title>
...
function clear_fields() {
  show_file('i3admins.mysql.php?update=-1');
}
  ...
  $( "#dialogListing" ).dialog({
    ...
    buttons: [
      ...
      },
      {
        text: "Update Listing",
        click: function() {
          attach_file('i3admins.mysql.php', 1);
          $( this ).dialog( "close" );
        }
      },
      {
        text: "Add Listing",
        click: function() {
          attach_file('i3admins.mysql.php', 0);
          $( this ).dialog( "close" );
        }
      }
    ]
...
<p>This listing consists of the systems managed by i3 App Sys Admins. The listing is automatically generated. To add a server to 
...
<ul>
  ...
  <ul>
    <li><strong>Refresh Listing</strong> - This rebuilds the i3 server listing file.</li>
  </ul></li>
</ul>
...
<input type="button"                 name="refresh" value="Refresh Listing" onClick="javascript:attach_file('i3admins.mysql.php', 2);">
</td>
</tr>
</table>
