...
<title>Manage Systems Engineering Listing</title>
...
function clear_fields() {
  show_file('systems.mysql.php?update=-1');
}
  ...
  $( "#dialogListing" ).dialog({
    ...
    buttons: [
      ...
      },
      {
        text: "Update Listing",
        click: function() {
          attach_file('systems.mysql.php', 1);
          $( this ).dialog( "close" );
        }
      },
      {
        text: "Add Listing",
        click: function() {
          attach_file('systems.mysql.php', 0);
          $( this ).dialog( "close" );
        }
      }
    ]
...
<input type="button"                 name="refresh" value="Refresh Listing" onClick="javascript:attach_file('systems.mysql.php', 2);">
</td>
</tr>
</table>
