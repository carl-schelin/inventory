...
function attach_file( p_script_url, update ) {
  ...
  af_url += "&spd_default="    + af_form.spd_default.checked;
...
function update_file( p_script_url, update ) {
  ...
  uf_url += "&spd_default="    + uf_form.spd_default.checked;
...
interface that's used to define speed. The text can be anything descriptive. In the listing below, a Network Speed 
...
<tr>
  <td class="ui-widget-content">Default? <input type="checkbox" name="spd_default"></td>
</tr>
</table>
