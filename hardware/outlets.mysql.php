...
# Description: Retrieve data and update the database with the new info. Prepare and display the table
  ...
  if (isset($_SESSION['username'])) {
    ...
    if (check_userlevel($db, $AL_Edit)) {
      ...
      $total = 0;
      $q_string  = "select out_id,out_name,out_active,out_desc,out_facing,plug_text,ast_name ";
...
#          $total = mysqli_num_rows($q_models);
          ...
          $output .= "  <td class=\"" . $class . "\">"        . $linkstart . $a_inv_outlets['ast_name']  . $linkend . "</td>";
          ...
          $output .= "<tr>";
          $output .= "  <td class=\"ui-widget-content\" colspan=\"7\">No Power Outlets found</td>";
          $output .= "</tr>";
      }
