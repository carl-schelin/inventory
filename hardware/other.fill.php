...
# Description: 
  ...
  if (isset($_SESSION['username'])) {
    ...
    if (check_userlevel($db, $AL_Edit)) {
      ...
      $modtype   = return_Index($db, $a_models['mod_type'],   "select type_id from parts order by part_name");

      print "document.updateDialog.mod_vendor.value = '" . mysqli_real_escape_string($db, $a_models['mod_vendor']) . "';\n";
