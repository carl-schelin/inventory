...
# Description: 
  ...
  if (isset($_SESSION['username'])) {
    ...
    if (check_userlevel($db, $AL_Edit)) {
      logaccess($db, $_SESSION['uid'], $package, "Requesting record " . $formVars['id'] . " from inv_parts");
      ...
      print "document.formUpdate.part_name.value = '"    . mysqli_real_escape_string($db, $a_inv_parts['part_name'])    . "';\n";
      print "document.formUpdate.part_acronym.value = '" . mysqli_real_escape_string($db, $a_inv_parts['part_acronym']) . "';\n";

      if ($a_inv_parts['part_type']) {
