  ...
  if (isset($_SESSION['username'])) {
    ...
    if (check_userlevel($db, $AL_Edit)) {
      ...
      if (check_userlevel($db, $AL_Admin)) {
        $output .= "  <th class=\"ui-state-default\" width=\"160\">Delete Memory</th>\n";
      }
      $output .= "  <th class=\"ui-state-default\">Vendor</th>\n";
      $output .= "  <th class=\"ui-state-default\">Model</th>\n";
      $output .= "  <th class=\"ui-state-default\">Amount of Memory</th>\n";
      ...
      if (mysqli_num_rows($q_models) > 0) {
        while ($a_models = mysqli_fetch_array($q_models)) {
          ...
          $linkstart = "<a href=\"#\" onclick=\"show_file('memory.fill.php?id="  . $a_models['mod_id'] . "');jQuery('#dialogUpdate').dialog('open');return false;\">";
          $linkdel   = "<input type=\"button\" value=\"Remove\"  onclick=\"delete_line('memory.del.php?id=" . $a_models['mod_id'] . "');\">";
          $linkend   = "</a>";
          ...
          $output .= "  <td class=\"" . $class . " delete\">"              . $a_models['mod_size']            . "</td>";
        ...
        $output .= "<tr>";
        $output .= "  <td class=\"ui-widget-content\" colspan=\"5\">No memory found</td>";
        $output .= "</tr>";
      }
