...
<tr>
  <td class="ui-widget-content">Device: <select name="out_deviceid">
<?php
...
<tr>
  <td class="ui-widget-content">Name: <input type="text" name="out_name" size="30"></td>
</tr>
<tr>
  <td class="ui-widget-content">Outlet Type: <select name="out_type">
<?php
...
<tr>
  <td class="ui-widget-content"><label>Is the Port Actively in use? <input type="checkbox" name="out_active"></label></td>
</tr>
<tr>
