...
function delete_line( p_script_url ) {
  var answer = confirm("Delete this Storage device?")
...
function clear_fields() {
  show_file('storage.mysql.php?update=-1');
}
...
$(document).ready( function() {
  ...
  $( "#dialogUpdate" ).dialog({
    ...
    buttons: [
      ...
      {
        text: "Update Storage Device",
        click: function() {
          update_file('storage.mysql.php', 1);
          $( this ).dialog( "close" );
        }
      },
      {
...
<tr>
  <th class="ui-state-default">Storage Editor</a></th>
...
<p>This is one piece of the Asset Management System. You add Storage devices here which are then used in the Asset system to configure a server. 
In this situation, you might create a generic storage device vs defining a bunch of specific ones. But you can should you have a system where you 
have a specific purpose and need a specific Storage device such as if you have a SSD storage device, you can define a SSD Storage device and then 
create an asset for the Storage device and assign it to a device.</p>
...
<table class="ui-styled-table">
<tr>
  <td class="ui-widget-content button"><input type="button" id="clickCreate" value="Add Storage Device"></td>
</tr>
</table>
...
<table class="ui-styled-table">
<tr>
  <th class="ui-state-default">Storage Listing</th>
  <th class="ui-state-default" width="20"><a href="javascript:;" onmousedown="toggleDiv('storage-listing-help');">Help</a></th>
</tr>
</table>

<div id="storage-listing-help" style="<?php print $display; ?>">

<div class="main-help ui-widget-content">

<p><strong>Storage Listing</strong></p>

<p>This page lists all the defined Storage units that can be used to define an asset.</p>

<p>To add an item of Storage, click the <strong>Add Storage Device</strong> button. This will bring up a dialog box which you can use 
to create a new Storage device.</p>

<p>To edit an existing item of Storage, click on an entry in the listing. A dialog box will be presented where you can edit 
the current entry, or if there is a small difference, you can make changes and add a new Storage device.</p>

<p>Note that under the Members colum is a number which indicates the number of times this item of Storage is in use. You cannot 
delete a Storage device as long as this value is greater than zero.</p>
...
<div id="dialogCreate" title="Add Storage Form">
...
<div id="dialogUpdate" title="Update Storage Form">
