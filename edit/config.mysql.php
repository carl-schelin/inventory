...
# button to sync Inventory with RSDP or RSDP with Inventory. A << >> button?
      ...
      print "document.getElementById('cfg_detail_table').innerHTML = '" . mysql_real_escape_string($output) . "';\n\n";
...
# the hardware form
      ...
      print "document.getElementById('cfg_hardware_table').innerHTML = '" . mysql_real_escape_string($output) . "';\n\n";
...
# the network interface form
      ...
      print "document.getElementById('cfg_network_table').innerHTML = '" . mysql_real_escape_string($output) . "';\n\n";
...
#      print "document.getElementById('cfg_backup_table').innerHTML = '" . mysql_real_escape_string($output) . "';\n\n";
