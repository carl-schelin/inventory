...
# Description: Fill in the table for editing.
  ...
  if (isset($_SESSION['username'])) {
    ...
    if (check_userlevel($db, $AL_Edit)) {
      logaccess($db, $_SESSION['uid'], $package, "Requesting record " . $formVars['id'] . " from inv_routing");
      ...
      print "document.edit.route_address.value = '" . mysqli_real_escape_string($db, $a_inv_routing['route_address']) . "';\n";
      print "document.edit.route_gateway.value = '" . mysqli_real_escape_string($db, $a_inv_routing['route_gateway']) . "';\n";
      print "document.edit.route_desc.value = '"    . mysqli_real_escape_string($db, $a_inv_routing['route_desc'])    . "';\n";
      print "document.edit.route_source.value = '"  . mysqli_real_escape_string($db, $a_inv_routing['route_source'])  . "';\n";

      print "document.edit.route_mask['"      . $a_inv_routing['route_mask'] . "'].selected = true;\n";
