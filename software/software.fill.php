...
# Description: 
  ...
  if (isset($_SESSION['username'])) {
    ...
    if (check_userlevel($db, $AL_Edit)) {
      ...
      $sw_product    = return_Index($db, $a_software['sw_product'],    "select prod_id from inv_products   order by prod_name");
      $sw_licenseid  = return_Index($db, $a_software['sw_licenseid'],  "select lic_id  from inv_licenses   order by lic_product");
