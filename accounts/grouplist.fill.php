...
# Description: 
  ...
  if (isset($_SESSION['username'])) {
    ...
    if (check_userlevel($db, $AL_Admin)) {
      logaccess($db, $_SESSION['uid'], $package, "Requesting record " . $formVars['id'] . " from grouplist");
      ...
      $gpl_group  = return_Index($db, $a_grouplist['gpl_group'], $q_string);
      $gpl_user   = return_Index($db, $a_grouplist['gpl_user'], "select usr_id from users where usr_disabled = 0 order by usr_last,usr_first");
