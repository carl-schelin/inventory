...
# Description: 
  ...
  if (isset($_SESSION['username'])) {
    ...
    if (check_userlevel($db, $AL_Admin)) {
      ...
      print "document.formUpdate.usr_name.value = '"       . mysqli_real_escape_string($db, $a_inv_users['usr_name'])     . "';\n";
      print "document.formUpdate.usr_first.value = '"      . mysqli_real_escape_string($db, $a_inv_users['usr_first'])    . "';\n";
      print "document.formUpdate.usr_last.value = '"       . mysqli_real_escape_string($db, $a_inv_users['usr_last'])     . "';\n";
      print "document.formUpdate.usr_email.value = '"      . mysqli_real_escape_string($db, $a_inv_users['usr_email'])    . "';\n";
      print "document.formUpdate.usr_phone.value = '"      . mysqli_real_escape_string($db, $a_inv_users['usr_phone'])    . "';\n";
      print "document.formUpdate.usr_notify.value = '"     . mysqli_real_escape_string($db, $a_inv_users['usr_notify'])   . "';\n";
      print "document.formUpdate.usr_freq.value = '"       . mysqli_real_escape_string($db, $a_inv_users['usr_freq'])     . "';\n";
