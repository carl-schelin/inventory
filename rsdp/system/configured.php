...
<?php print submit_RSDP( $formVars['rsdp'], 12, $RSDProot . "/system/configured.mysql.php", "rsdp_platformspoc", "rsdp_platform", 0); ?>
...
<?php print return_Checklist( $formVars['rsdp'], 12); ?>
</table>
