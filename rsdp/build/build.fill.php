...
# Description: 
  ...
  if (isset($_SESSION['username'])) {
    ...
    if (check_userlevel($AL_Edit)) {
      ...
      $numrows = mysql_num_rows($q_rsdp_platform);
      ...
      if (mysql_num_rows($q_rsdp_platform) > 0) {
        ...
        print "document.rsdp.pf_asset.value = '"   . mysql_real_escape_string($a_rsdp_platform['pf_asset'])   . "';\n";
        print "document.rsdp.pf_serial.value = '"  . mysql_real_escape_string($a_rsdp_platform['pf_serial'])  . "';\n";
        ...
        print "document.rsdp.pf_special.value = '" . mysql_real_escape_string($a_rsdp_platform['pf_special']) . "';\n";
      ...
      $numrows = mysql_num_rows($q_rsdp_osteam);
      ...
      if (mysql_num_rows($q_rsdp_osteam) > 0) {
        ...
        print "document.rsdp.os_sysname.value = '" . mysql_real_escape_string($a_rsdp_osteam['os_sysname']) . "';\n";
        print "document.rsdp.os_fqdn.value = '"    . mysql_real_escape_string($a_rsdp_osteam['os_fqdn'])    . "';\n";
      ...
      mysql_free_result($q_rsdp_osteam);
