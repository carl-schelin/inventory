...
<?php print submit_RSDP( $formVars['rsdp'], 15, $RSDProot . "/application/installed.mysql.php", "rsdp_apppoc", "rsdp_application", 0); ?>
...
<?php print return_Checklist( $formVars['rsdp'], 15); ?>
</table>
