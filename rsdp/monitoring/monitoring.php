...
<?php print submit_RSDP( $formVars['rsdp'], 14, $RSDProot . "/monitoring/monitoring.mysql.php", "rsdp_monitorpoc", "", $GRP_Monitoring); ?>
...
<?php print return_Checklist( $formVars['rsdp'], 14); ?>
</table>
