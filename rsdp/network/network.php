...
<?php print submit_RSDP( $formVars['rsdp'], 4, $RSDProot . "/network/network.mysql.php", "rsdp_networkpoc", "", $GRP_Networking); ?>
...
<?php
  if (rsdp_Virtual($formVars['rsdp']) == 0) {
?>
...
<?php print return_Checklist( $formVars['rsdp'], 4); ?>
</table>
