...
# get systems to be managed through nagios
  ...
  $q_string .= "where int_nagios = 1 and inv_status = 0 and sw_type = 'OS' and hw_active != '0000-00-00' and int_ip6 = 0 and int_type = 1 and inv_location = 39 and inv_manager != 12 ";
