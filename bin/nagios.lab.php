...
# get systems to be managed through nagios
  ...
  $q_string .= "int_addr,int_gate,int_xpoint,int_ypoint,int_zpoint,int_ssh,int_ping,int_http,";
  ...
  $q_string .= "where int_nagios = 1 and inv_status = 0 and sw_type = 'OS' and int_ip6 = 0 and int_type != 6 and int_type != 4 and loc_type = 1 and loc_instance = 0 and inv_manager = 1 ";
  if ($hostname == 'inventory.scc911.com') {
