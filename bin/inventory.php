...
# let's show the number of entries for each of the tables for this server id.
      ...
      if (mysql_num_rows($q_alarms) > 0) {
        $alarms = mysql_num_rows($q_alarms);
        print "There are " . mysql_num_rows($q_alarms) . " alarm records for " . $a_inventory['inv_name'] . "\n";
      }
      ...
      if (mysql_num_rows($q_backups) > 0) {
        print "There is a backup record " . mysql_num_rows($q_backups) . " for " . $a_inventory['inv_name'] . "\n";
        $backups = mysql_num_rows($q_backups);
      }
      ...
      if (mysql_num_rows($q_cluster) > 0) {
        print "There are " . mysql_num_rows($q_cluster) . " cluster records for " . $a_inventory['inv_name'] . "\n";
        $cluster = mysql_num_rows($q_cluster);
      }
      ...
      if (mysql_num_rows($q_filesystem) > 0) {
        print "There are " . mysql_num_rows($q_filesystem) . " filesystem records for " . $a_inventory['inv_name'] . "\n";
        $filesystem = mysql_num_rows($q_filesystem);
      }
      ...
      if (mysql_num_rows($q_firewall) > 0) {
        print "There are " . mysql_num_rows($q_firewall) . " firewall records for " . $a_inventory['inv_name'] . "\n";
        $firewall = mysql_num_rows($q_firewall);
      }
      ...
      if (mysql_num_rows($q_hardware) > 0) {
        print "There are " . mysql_num_rows($q_hardware) . " hardware records for " . $a_inventory['inv_name'] . "\n";
        $hardware = mysql_num_rows($q_hardware);
      }
      ...
      if (mysql_num_rows($q_interface) > 0) {
        print "There are " . mysql_num_rows($q_interface) . " interface records for " . $a_inventory['inv_name'] . "\n";
        $interface = mysql_num_rows($q_interface);
        while ($a_interface = mysql_fetch_array($q_interface)) {
          ...
          if (mysql_num_rows($q_vulnerabilities) > 0) {
            print " -- There are " . mysql_num_rows($q_vulnerabilities) . " vulnerability records for " . $a_interface['int_addr'] . "\n";
          }
          ...
          if (mysql_num_rows($q_vulnowner) > 0) {
            print " -- There are " . mysql_num_rows($q_vulnowner) . " vulnerability ticket records for " . $a_interface['int_addr'] . "\n";
          }
        }
      }
      ...
      if (mysql_num_rows($q_issue) > 0) {
        print "There are " . mysql_num_rows($q_issue) . " issue tracker records for " . $a_inventory['inv_name'] . "\n";
        $issues = mysql_num_rows($q_issue);
        while ($a_issue = mysql_fetch_array($q_issue)) {
          ...
          if (mysql_num_rows($q_issue_detail) > 0) {
            print " -- There are " . mysql_num_rows($q_issue_detail) . " detail records for issue " . $a_issue['iss_id'] . "\n";
          }
          ...
          if (mysql_num_rows($q_issue_morning) > 0) {
            print " -- There are " . mysql_num_rows($q_issue_morning) . " morning report records for issue " . $a_issue['iss_id'] . "\n";
          }
          ...
          if (mysql_num_rows($q_issue_support) > 0) {
            print " -- There are " . mysql_num_rows($q_issue_support) . " support records for issue " . $a_issue['iss_id'] . "\n";
          }
          ...
          if (mysql_num_rows($q_report) > 0) {
            print " -- There are " . mysql_num_rows($q_report) . " morning report entries for issue " . $a_issue['iss_id'] . "\n";
          }
        }
      }
      ...
      $q_maint = mysql_query($q_string) or die($q_string . ": " . mysql_error());
      if (mysql_num_rows($q_maint) > 0) {
        print "There are " . mysql_num_rows($q_maint) . " maintenance outage records for " . $a_inventory['inv_name'] . "\n";
        $maintenance = mysql_num_rows($q_maint);
      }
      ...
      $q_outage = mysql_query($q_string) or die($q_string . ": " . mysql_error());
      if (mysql_num_rows($q_outage) > 0) {
        print "There are " . mysql_num_rows($q_outage) . " outage records for " . $a_inventory['inv_name'] . "\n";
        $outages = mysql_num_rows($q_outage);
      }
      ...
      if (mysql_num_rows($q_packages) > 0) {
        print "There are " . mysql_num_rows($q_packages) . " package records for " . $a_inventory['inv_name'] . "\n";
        $packages = mysql_num_rows($q_packages);
      }
      ...
      if (mysql_num_rows($q_psaps) > 0) {
        print "There are " . mysql_num_rows($q_psaps) . " psap records for " . $a_inventory['inv_name'] . "\n";
        $psaps = mysql_num_rows($q_psaps);
      }
      ...
      $q_retire = mysql_query($q_string) or die($q_string . ": " . mysql_error());
      if (mysql_num_rows($q_retire) > 0) {
        print "There are " . mysql_num_rows($q_retire) . " retirement records for " . $a_inventory['inv_name'] . "\n";
        $retirements = mysql_num_rows($q_retire);
      }
      ...
      if (mysql_num_rows($q_routing) > 0) {
        print "There are " . mysql_num_rows($q_routing) . " routing records for " . $a_inventory['inv_name'] . "\n";
        $routes = mysql_num_rows($q_routing);
      }
      ...
      $q_san = mysql_query($q_string) or die($q_string . ": " . mysql_error());
      if (mysql_num_rows($q_san) > 0) {
        print "There are " . mysql_num_rows($q_san) . " san storage records for " . $a_inventory['inv_name'] . "\n";
        $san = mysql_num_rows($q_san);
      }
      ...
      if (mysql_num_rows($q_software) > 0) {
        print "There are " . mysql_num_rows($q_software) . " software records for " . $a_inventory['inv_name'] . "\n";
        $software = mysql_num_rows($q_software);
      }
      ...
      if (mysql_num_rows($q_sysgrp) > 0) {
        print "There are " . mysql_num_rows($q_sysgrp) . " system group records for " . $a_inventory['inv_name'] . "\n";
        $groups = mysql_num_rows($q_sysgrp);
      }
      ...
      if (mysql_num_rows($q_syspwd) > 0) {
        print "There are " . mysql_num_rows($q_syspwd) . " system user records for " . $a_inventory['inv_name'] . "\n";
        $users = mysql_num_rows($q_syspwd);
      }
