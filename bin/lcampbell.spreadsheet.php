...
# root.cron: 30 8 * * * /usr/local/bin/php /usr/local/httpd/bin/lcampbell.spreadsheet.php > /usr/local/httpd/htsecure/reports/lcampbell.spreadsheet.csv 2>/dev/null
  ...
  print "\"Server Name\",\"Operating System\",\"Location Name\",\"Address\",\"Address\",\"Suite\",\"City\",\"State\",\"Zipcode\",\",\"Make\",\"Model\",\"Function\"\n";

  $q_string  = "select inv_id,inv_name,inv_function,sw_software,mod_vendor,mod_name,loc_name,loc_addr1,loc_addr2,loc_suite,loc_city,loc_state,loc_zipcode ";
  ...
  while ($a_inventory = mysql_fetch_array($q_inventory)) {
    ...
    print "\"" . $a_inventory['loc_city'] . "\",";
    print "\"" . $a_inventory['loc_state'] . "\",";
