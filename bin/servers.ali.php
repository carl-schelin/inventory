...
# Description: 
  ...
  $q_string .= "where (inv_manager = " . $GRP_ALIMAdmin . " or sw_group = " . $GRP_ALIMAdmin . ") and inv_status = 0 ";
...
# add the centrify application for changelog work
  ...
  $q_string .= "where cl_group = " . $GRP_ALIMAdmin . " and cl_delete = 0 ";
