...
<title>Inventory Hardware Sanity Listing</title>
...
# or country == 0 and location >  0
  ...
  print "  <th class=\"ui-state-default\">Hardware Group</th>\n";
  print "</tr>";
...
# pass the server id and hardware group. the system will change to be owned by the hardware group
      $custodian = "<a href=\"#\" onclick=\"javascript:show_file('change.custodian.php?id=" . $a_inventory['inv_id'] . "&custodian=" . $a_hardware['hw_group'] . "');\">";

      print "<tr>\n";
      print "  <td class=\"ui-widget-content\">"                                                          . $editstart . $a_inventory['inv_name'] . $editend . "</td>\n";
      print "  <td class=\"ui-widget-content\" title=\"Update all hardware with this Custodian\">"        . $hardware  . $a_inventory['grp_name'] . $editend . "</td>\n";
      print "  <td class=\"ui-widget-content\" title=\"Update system and all hardware with this group\">" . $custodian . $a_hardware['grp_name']  . $editend . "</td>\n";
      print "</tr>\n";
    }
  }
