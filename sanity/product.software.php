...
<title>Product Software Sanity Listing</title>
...
# or country == 0 and location >  0
  ...
  print "<tr>";
  print "  <th class=\"ui-state-default\">Product Software Sanity Listing</th>";
  ...
  print "<p>This page lists all software that has a product id of zero, as in not associated with any product.</p>\n";
  ...
  print "  <th class=\"ui-state-default\">Software Product</th>\n";
  print "</tr>";
  ...
  while ($a_inventory = mysqli_fetch_array($q_inventory)) {
   ...
   $editstart = '';
    ...
    $q_string .= "where sw_companyid = " . $a_inventory['inv_id'] . " and sw_product = 0 ";
    $q_software = mysqli_query($db, $q_string) or die($q_string . ": " . mysqli_error($db));
    while ($a_software = mysqli_fetch_array($q_software)) {
      print "<tr>\n";
      print "  <td class=\"ui-widget-content\">" . $editstart . $a_inventory['inv_name']   . $editstop . "</td>\n";
      print "  <td class=\"ui-widget-content\">" . $editstart . $a_inventory['prod_name']  . $editstop . "</td>\n";
      print "  <td class=\"ui-widget-content\">" . $editstart . $a_inventory['grp_name']   . $editstop . "</td>\n";
      print "  <td class=\"ui-widget-content\">"              . $a_software['sw_software']             . "</td>\n";
      print "  <td class=\"ui-widget-content\">"              . $a_software['prod_name']               . "</td>\n";
      print "</tr>";
    }
  }
